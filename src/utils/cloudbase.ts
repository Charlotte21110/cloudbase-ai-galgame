...
export const init = (config: any = {}) => {
  const appConfig = {
    ...
    // 仅在 App 端（iOS/Android）需要配置，H5 / 小程序可忽略
    appSign: import.meta.env.VITE_APP_SIGN || "",
    appSecret: {
      appAccessKeyId: Number(import.meta.env.VITE_APP_ACCESS_KEY_ID || 1),
      appAccessKey: import.meta.env.VITE_APP_ACCESS_KEY || "",
    },
  };
